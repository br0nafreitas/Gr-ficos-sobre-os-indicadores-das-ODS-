...
final <- mapa1 + mapa2 + mapa3 + 
  plot_annotation(title = "Proporção do valor adicionado nas indústrias tecnológicas no valor adicionado total no Brasil (%)",
...
ggsave("tecnologia_map.png", width = 9.5, height = 4.0, units = "in")
